...
{
\textbf{}   
\\$\bullet$ Designed the solution and created the scalable RESTful service for IoT devices that improved their configurations update process
\\$\bullet$ Developed the event-driven cross-database replication service that allowed to have the loose coupling between microservices
\\$\bullet$ Enhanced deployment efficiency by refining the CI pipeline, resulting in a 40% increase in daily deployments
