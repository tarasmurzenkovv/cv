...
5. Improved latency by 30\% of the existing ElasticSearch queries \newline
6. Created the integration with the 3rd party analytical service with the average throughput 1 MB/s \newline
7. Improved performance of DAO layer by 70\%  \newline
8. Created library to detect the Hibernate N+1 problem and optimizing existing queries \newline
9. Scaled code review process by automating the code quality checks 
...
5. Implementing scalable and resilient web services using microservices and reactive paradigm
 }
