...
{
\textbf{Languages:} Java 8-17, Kotlin, Groovy, SQL/HQL, JavaScript, Dart\newline
...
\textbf{Ops. tools:} Jenkins, Docker, Kubernetes, CircleCI, Gradle, Bash scripting, Kubernetes, Terraform \newline
...
6. Created library to detect the Hibernate N+1 problem and used it to optimize throughput of existing queries by 70\%  \newline
