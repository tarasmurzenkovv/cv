...
{
\textbf{}   
\\$\bullet$ Created the highly scalable cross-database, event-driven replication service (DynamoDB, Lambda, Terraform, Python)
\\$\bullet$ Designed and created configuration service that allows remote IoT devices to update their configuration (AWS, Terraform, Kotlin, http4k)
